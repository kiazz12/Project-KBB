...
**Database:**
- Users with OPD assignment
- Forms with data classification
...
- Authorization service untuk consistency
...
### Service Injection
Semua domain services sudah siap untuk dependency injection. Gunakan constructor injection di controllers:
...
Selalu gunakan `AuthorizationService` untuk check permissions:
...
### Query Constraints
Apply access constraints di setiap query:
