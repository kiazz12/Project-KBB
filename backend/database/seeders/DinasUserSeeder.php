...
class DinasUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $accounts = [
            ...
            ['name' => 'Dinas Arsip dan Perpustakaan', 'slug' => 'diarpus'],
            ['name' => 'Dinas Pariwisata dan Kebudayaan', 'slug' => 'disbudpar'],
            ['name' => 'Dinas Pekerjaan Umum dan Tata Ruang', 'slug' => 'pupr'],
