...
<div class="w-full max-w-sm relative z-10">
    <div class="bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.3)] overflow-hidden">
        <div class="bg-gradient-to-br from-kbb-700 via-kbb-800 to-[#001a3a] px-8 pt-8 pb-6 text-white relative overflow-hidden">
            ...
            <div class="absolute top-1/2 right-8 w-1 h-1 bg-white/10 rounded-full"></div>
            ...
            <div class="relative text-center">
                ...
                <h1 class="text-xl font-bold">KBB Admin Panel</h1>
                <p class="text-kbb-200/80 text-sm mt-0.5">Super Admin — Kabupaten Bandung Barat</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.login.post') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" required autofocus
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-kbb-500/20 focus:border-kbb-500 focus:bg-white outline-none transition text-sm placeholder:text-gray-400 bg-white" placeholder="admin@dinas.com">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Password</label>
                    <div class="relative">
                        <input id="password-field" type="password" name="password" required
                            class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-kbb-500/20 focus:border-kbb-500 focus:bg-white outline-none transition pr-12 text-sm placeholder:text-gray-400 bg-white" placeholder="••••••••">
                        <button type="button" id="toggle-password" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 p-1.5 rounded-lg hover:bg-gray-100 transition">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2.5 cursor-pointer select-none">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-gray-300 text-kbb-700 focus:ring-kbb-500/20 focus:ring-offset-0">
