...
<div class="w-full max-w-sm relative z-10">
    <div class="bg-white/70 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
        <div class="text-center mb-8">
            <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-kbb-100 to-kbb-200 rounded-2xl flex items-center justify-center shadow-lg shadow-kbb-200/30">
...
@if (session('error'))
    <div class="mb-4 px-4 py-3 bg-red-50/80 backdrop-blur border border-red-200 text-red-700 rounded-lg text-sm">{{ session('error') }}</div>
@endif
