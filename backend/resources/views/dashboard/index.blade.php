        ...
        <div class="relative">
            <div class="flex items-start justify-between flex-wrap gap-4">
                <div>
                    ...
                    <h1 class="text-3xl font-bold tracking-tight">Selamat datang, {{ auth()->user()->currentDisplayName() }}</h1>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center gap-3 mt-3 text-xs">
                    <span class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 font-medium">
                        <span class="w-1.5 h-1.5 rounded-full bg-emerald-500"></span>
                        {{ $publishedForms }} published
                    </span>
                    <span class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-gray-100 dark:bg-slate-700 text-gray-500 dark:text-gray-400 font-medium">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="flex items-center gap-3 mt-3 text-xs">
                    ...
                    <span class="flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-kbb-50 dark:bg-kbb-500/15 text-kbb-700 dark:text-kbb-400 font-medium">
    ...
    <div class="group bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-gray-900 dark:text-gray-100 mt-1.5">{{ $publishedForms }}</p>
                <div class="mt-3 text-xs space-y-1">
                    <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400 font-medium">
                    ...
                    <p class="text-gray-400 dark:text-gray-500 px-1 mt-1">{{ $avgSubsPerForm }} rata-rata/form</p>
                </div>
            </div>
    ...
    <div class="group bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
        <div class="flex items-center justify-between">
            <div>
                ...
                <div class="mt-3 text-xs space-y-1">
                    <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-purple-50 dark:bg-purple-500/15 text-purple-700 dark:text-purple-400 font-medium">
                        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                        {{ \App\Models\User::where('role', 'admin')->count() }} admin
                    </span>
                </div>
                <a href="{{ route('users.index') }}" class="inline-flex items-center gap-1 text-xs text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300 font-medium mt-1.5 px-1">
                    Kelola Pengguna
    ...
    @else
    <a href="{{ route('forms.create') }}"
       class="group bg-white dark:bg-slate-800 rounded-2xl shadow-sm border-2 border-dashed border-gray-200 dark:border-slate-600 p-6 flex items-center justify-center hover:border-kbb-400 hover:bg-kbb-50/30 dark:hover:bg-kbb-500/10 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg">
        <div class="text-center">
            <div class="w-12 h-12 mx-auto rounded-xl bg-gray-100 dark:bg-slate-700 group-hover:bg-kbb-100 dark:group-hover:bg-kbb-500/20 flex items-center justify-center transition-all duration-200 group-hover:scale-110">
                <svg class="w-6 h-6 text-gray-400 dark:text-gray-500 group-hover:text-kbb-700 dark:group-hover:text-kbb-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>
            </div>
            <p class="text-sm font-medium text-gray-500 dark:text-gray-400 group-hover:text-kbb-700 dark:group-hover:text-kbb-400 mt-3 transition-colors">Buat Form Baru</p>
        </div>
    </a>
    @endif
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Status Form</h2>
        </div>
        @if($totalForms > 0)
        <div class="space-y-5">
            <div>
                <div class="flex items-center justify-between text-sm mb-1.5">
                    <span class="flex items-center gap-2">
                        ...
                        <span class="text-gray-600 dark:text-gray-300 font-medium">Published</span>
                    </span>
                    <span class="font-bold text-gray-900 dark:text-gray-100">{{ $publishedForms }}</span>
                </div>
                <div class="w-full h-3 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
            ...
            <div>
                <div class="flex items-center justify-between text-sm mb-1.5">
                    <span class="flex items-center gap-2">
                        ...
                        <span class="text-gray-600 dark:text-gray-300 font-medium">Draft</span>
                    </span>
                    <span class="font-bold text-gray-900 dark:text-gray-100">{{ $draftForms }}</span>
                </div>
                <div class="w-full h-3 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
            ...
            <div>
                <div class="flex items-center justify-between text-sm mb-1.5">
                    <span class="flex items-center gap-2">
                        ...
                        <span class="text-gray-600 dark:text-gray-300 font-medium">Closed</span>
                    </span>
                    <span class="font-bold text-gray-900 dark:text-gray-100">{{ $closedForms }}</span>
                </div>
                <div class="w-full h-3 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
            ...
            <div class="pt-3 border-t border-gray-100 dark:border-slate-700">
                <div class="flex items-center justify-between text-sm mb-1.5">
                    <span class="flex items-center gap-2">
                        ...
                        <span class="text-gray-600 dark:text-gray-300 font-medium">Form dengan respons</span>
                    </span>
                    <span class="font-bold text-gray-900 dark:text-gray-100">{{ $formsWithSubmissions }} / {{ $publishedForms }}</span>
                </div>
                <div class="w-full h-3 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden shadow-inner">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Form Terpopuler</h2>
            <a href="{{ route('forms.index') }}" class="text-sm text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300 font-medium inline-flex items-center gap-1">
                Lihat Semua
        ...
        <div class="space-y-1.5">
            ...
            <a href="{{ route('forms.show', $form) }}"
               class="flex items-center justify-between p-3.5 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-all group">
                <div class="flex items-center gap-3.5 min-w-0">
                    <div class="w-8 h-8 rounded-xl flex items-center justify-center text-sm font-bold flex-shrink-0 {{ $i === 0 ? 'bg-gradient-to-br from-amber-400 to-orange-500 text-white shadow-sm' : ($i === 1 ? 'bg-gradient-to-br from-gray-300 to-gray-400 text-white shadow-sm' : ($i === 2 ? 'bg-gradient-to-br from-orange-300 to-orange-400 text-white shadow-sm' : 'bg-gray-100 dark:bg-slate-700 text-gray-500 dark:text-gray-400')) }}">
                        {{ $i + 1 }}
                    </div>
                    <div class="min-w-0">
                        <p class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate group-hover:text-kbb-700 dark:group-hover:text-kbb-400 transition-colors">{{ $form->title }}</p>
                        <p class="text-xs text-gray-400 mt-0.5">
                            <span class="font-medium text-gray-600 dark:text-gray-300">{{ $form->submissions_count }}</span> respons
                            @if(auth()->user()->isSuperAdmin())
                                <span class="text-gray-300 dark:text-gray-600">&middot;</span> {{ $form->user?->name ?? 'Unknown' }}
                            @endif
                        </p>
                    </div>
                </div>
                <div class="flex items-center gap-2.5 flex-shrink-0 ml-2">
                    <span class="text-xs px-2.5 py-1 rounded-full font-semibold {{ $form->status->value === 'published' ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400' : ($form->status->value === 'closed' ? 'bg-red-50 text-red-700 dark:bg-red-500/15 dark:text-red-400' : 'bg-gray-100 text-gray-500 dark:bg-slate-700 dark:text-gray-400') }}">
                        {{ $form->status }}
                    </span>
                    <svg class="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-gray-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                </div>
            </a>
            @endforeach
        </div>
        ...
        <div class="text-center py-10">
            <div class="w-14 h-14 bg-gray-50 dark:bg-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-3">
                <svg class="w-7 h-7 text-gray-300 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
            </div>
            <p class="text-sm text-gray-400">Belum ada respons masuk</p>
            <a href="{{ route('forms.create') }}" class="text-sm text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300 font-medium mt-2 inline-flex items-center gap-1">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Aktivitas Terbaru</h2>
        </div>
        @if ($latestSubmissions->isNotEmpty())
        <div class="space-y-1.5">
            @foreach ($latestSubmissions as $submission)
            <div class="flex items-start gap-3.5 p-3 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-all group">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                        Respons baru di
                        <a href="{{ route('forms.submissions.index', $submission->form_id) }}" class="font-semibold text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300">
        ...
        <div class="text-center py-10">
            <div class="w-14 h-14 bg-gray-50 dark:bg-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-3">
                <svg class="w-7 h-7 text-gray-300 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
    <div class="lg:col-span-3 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
        <div class="flex items-center justify-between mb-5">
            <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Forms Terbaru</h2>
            <a href="{{ route('forms.index') }}" class="text-sm text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300 font-medium inline-flex items-center gap-1">
                Lihat Semua
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
            </a>
        ...
        <div class="text-center py-10">
            <div class="w-14 h-14 bg-gray-50 dark:bg-slate-700 rounded-2xl flex items-center justify-center mx-auto mb-3">
                <svg class="w-7 h-7 text-gray-300 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            </div>
            <p class="text-sm text-gray-400">Belum ada form</p>
            <a href="{{ route('forms.create') }}" class="text-sm text-kbb-700 dark:text-kbb-400 hover:text-kbb-800 dark:hover:text-kbb-300 font-medium mt-2 inline-flex items-center gap-1">
                Buat form pertama
    ...
    <div class="lg:col-span-2 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 p-6">
        <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-5">Akses Cepat</h2>
        <div class="grid grid-cols-2 gap-3">
            <a href="{{ route('forms.index') }}"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-kbb-50 to-kbb-100/50 dark:from-kbb-500/10 dark:to-kbb-500/5 hover:from-kbb-100 hover:to-kbb-200/50 dark:hover:from-kbb-500/20 dark:hover:to-kbb-500/10 transition-all group border border-kbb-100/50 dark:border-kbb-500/20 hover:border-kbb-200 dark:hover:border-kbb-500/30 hover:shadow-md hover:-translate-y-0.5">
                <div class="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <span class="text-sm font-semibold text-kbb-800 dark:text-kbb-300">Semua Form</span>
            </a>
            <a href="{{ route('forms.create') }}"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-500/10 dark:to-emerald-500/5 hover:from-emerald-100 hover:to-emerald-200/50 dark:hover:from-emerald-500/20 dark:hover:to-emerald-500/10 transition-all group border border-emerald-100/50 dark:border-emerald-500/20 hover:border-emerald-200 dark:hover:border-emerald-500/30 hover:shadow-md hover:-translate-y-0.5">
                <div class="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <span class="text-sm font-semibold text-emerald-800 dark:text-emerald-300">Buat Form</span>
            </a>
            @if(auth()->user()->isSuperAdmin())
            <a href="{{ route('users.index') }}"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100/50 dark:from-purple-500/10 dark:to-purple-500/5 hover:from-purple-100 hover:to-purple-200/50 dark:hover:from-purple-500/20 dark:hover:to-purple-500/10 transition-all group border border-purple-100/50 dark:border-purple-500/20 hover:border-purple-200 dark:hover:border-purple-500/30 hover:shadow-md hover:-translate-y-0.5">
                <div class="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/></svg>
                </div>
                <span class="text-sm font-semibold text-purple-800 dark:text-purple-300">Kelola User</span>
            </a>
            <a href="{{ route('admin.dashboard') }}"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100/50 dark:from-amber-500/10 dark:to-amber-500/5 hover:from-amber-100 hover:to-amber-200/50 dark:hover:from-amber-500/20 dark:hover:to-amber-500/10 transition-all group border border-amber-100/50 dark:border-amber-500/20 hover:border-amber-200 dark:hover:border-amber-500/30 hover:shadow-md hover:-translate-y-0.5">
                <div class="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <span class="text-sm font-semibold text-amber-800 dark:text-amber-300">Admin Panel</span>
            </a>
            @else
            <a href="{{ route('change-password') }}"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100/50 dark:from-slate-600/20 dark:to-slate-600/10 hover:from-gray-100 hover:to-gray-200/50 dark:hover:from-slate-600/30 dark:hover:to-slate-600/15 transition-all group border border-gray-100/50 dark:border-slate-600/30 hover:border-gray-200 dark:hover:border-slate-500/40 hover:shadow-md hover:-translate-y-0.5">
                <div class="w-11 h-11 rounded-xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                <span class="text-sm font-semibold text-gray-800 dark:text-gray-300">Ubah Password</span>
            </a>
            <a href="{{ route('forms.index') }}?status=published"
               class="flex flex-col items-center gap-3 p-5 rounded-2xl bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-500/10 dark:to-emerald-500/5 hover:from-emerald-100 hover:to-emerald-200/50 dark:hover:from-emerald-500/20 dark:hover:to-emerald-500/10 transition-all group border border-emerald-100/50 dark:border-emerald-500/20 hover:border-emerald-200 dark:hover:border-emerald-500/30 hover:shadow-md hover:-translate-y-0.5">
                ...
                <span class="text-sm font-semibold text-emerald-800 dark:text-emerald-300">Form Aktif</span>
            </a>
            @endif
        </div>
    </div>
