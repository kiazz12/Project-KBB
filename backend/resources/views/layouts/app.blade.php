...
<head>
    ...
    <title>@yield('title', 'Dashboard') — KBB Forms</title>
    ...
    <div class="flex h-screen overflow-hidden">
        <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col flex-shrink-0 transition-all ml-0">
            <div class="h-16 flex items-center gap-3 px-5 border-b border-gray-100">
                <div class="w-8 h-8 bg-kbb-700 rounded-lg flex items-center justify-center text-white text-sm font-bold">K</div>
                <div>
                    <h2 class="font-semibold text-sm leading-tight">KBB Forms</h2>
