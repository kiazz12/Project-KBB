                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <select wire:model="fieldType"
                                ...
                                <option value="computed">Computed (Auto-Hitung)</option>
                            </select>
                        </div>
                        ...
                        @if ($fieldType === 'computed')
                            <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 space-y-3">
                                <h4 class="text-xs font-semibold text-amber-800 uppercase tracking-wider">Konfigurasi Formula</h4>
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Field Referensi</label>
                                    <select wire:model="fieldFormulaRef"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-kbb-500 outline-none transition">
                                        <option value="">Pilih field...</option>
                                        @foreach ($form->fields->where('type.value', 'number') as $f)
                                            <option value="{{ $f->id }}">{{ $f->label }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Operasi</label>
                                    <select wire:model="fieldFormulaOp"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-kbb-500 outline-none transition">
                                ...
                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Nilai Konstanta (opsional)</label>
                                    <input type="text" wire:model="fieldFormulaValue" placeholder="Mis: 0.05 untuk 5%"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-kbb-500 outline-none transition">
                                </div>
                            </div>
                        @endif
